...
class Cliente {
    ...
    static async cadastrarCliente(cliente: ClienteDTO): Promise<boolean> {
        try {
            ...
            const queryInsertCliente = `INSERT INTO clientes (cpf, nome, nascimento, telefone, email)
                                VALUES
                                ($1, $2, $3, $4, $5)
            ...
            const respostaBD = await database.query(queryInsertCliente, [
                ...
                cliente.nascimento,                // CPF do cliente
